...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # Adding model 'SearchResultPluginModel'
#        db.create_table('cmsplugin_searchresultpluginmodel', (
#            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
#            ('ressource_page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='opst_plugin_searchresult', to=orm['cms.Page'])),
#        ))
#        db.send_create_signal('opst_plugins', ['SearchResultPluginModel'])


    def backwards(self, orm):
        # Deleting model 'SearchResultPluginModel'
        db.delete_table('cmsplugin_searchresultpluginmodel')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 29, 0, 0)'}),
