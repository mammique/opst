...
#p=Page.objects.get(id='search')

class Migration(SchemaMigration):

    def forwards(self, orm):
        # Adding field 'SearchBoxPluginModel.ressource_page'
        db.add_column('cmsplugin_searchboxpluginmodel', 'ressource_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=183, related_name='opst_plugin_searchbox_ressource', to=orm['cms.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchBoxPluginModel.ressource_page'
        db.delete_column('cmsplugin_searchboxpluginmodel', 'ressource_page_id')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 26, 0, 0)'}),
        ...
        'opst_plugins.searchboxpluginmodel': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'ressource_page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'opst_plugin_searchbox_ressource'", 'to': "orm['cms.Page']"}),
            'result_page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'opst_plugin_searchbox_result'", 'to': "orm['cms.Page']"})
        },
