...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'ressource_subcat', 'ressource_subcats')

    def backwards(self, orm):
        db.rename_table(u'ressource_subcats', 'ressource_subcat')


        # Removing M2M table for field subcats on 'Ressource'
        db.delete_table('ressource_subcats')
