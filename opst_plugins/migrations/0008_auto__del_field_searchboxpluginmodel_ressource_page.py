...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SearchBoxPluginModel.ressource_page'
        raise RuntimeError("Cannot reverse this migration. 'SearchBoxPluginModel.ressource_page' and its values cannot be restored.")
