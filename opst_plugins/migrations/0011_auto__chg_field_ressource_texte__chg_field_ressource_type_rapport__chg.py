...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ressource.type_rapport'
        db.alter_column('opst_plugins_ressource', 'type_rapport', self.gf('django.db.models.fields.CharField')(max_length=767))

        # Changing field 'Ressource.type_production'
        db.alter_column('opst_plugins_ressource', 'type_production', self.gf('django.db.models.fields.CharField')(max_length=767))

        # Changing field 'Ressource.lien_texte'
        db.alter_column('opst_plugins_ressource', 'lien_texte', self.gf('django.db.models.fields.CharField')(max_length=767))

        # Changing field 'Ressource.titre'
        db.alter_column('opst_plugins_ressource', 'titre', self.gf('django.db.models.fields.CharField')(max_length=767))
    ...
    def backwards(self, orm):
        ...
        db.create_index('opst_plugins_ressource', ['texte'])
        ...
        # Changing field 'Ressource.type_rapport'
        db.alter_column('opst_plugins_ressource', 'type_rapport', self.gf('django.db.models.fields.CharField')(max_length=900))

        # Changing field 'Ressource.type_production'
        db.alter_column('opst_plugins_ressource', 'type_production', self.gf('django.db.models.fields.CharField')(max_length=900))

        # Changing field 'Ressource.lien_texte'
        db.alter_column('opst_plugins_ressource', 'lien_texte', self.gf('django.db.models.fields.CharField')(max_length=1800))

        # Changing field 'Ressource.titre'
        db.alter_column('opst_plugins_ressource', 'titre', self.gf('django.db.models.fields.CharField')(max_length=900))

        # Changing field 'Ressource.slug'
        db.alter_column('opst_plugins_ressource', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=900))
    ...
    models = {
        ...
        'opst_plugins.ressource': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '767', 'blank': 'True'}),
