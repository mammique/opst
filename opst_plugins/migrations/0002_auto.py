...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field category on 'Ressource'
        db.create_table(u'ressource_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ressource', models.ForeignKey(orm['opst_plugins.ressource'], null=False)),
            ('categorie', models.ForeignKey(orm['opst_plugins.categorie'], null=False))
        ))
        db.create_unique(u'ressource_category', ['ressource_id', 'categorie_id'])

        # Adding M2M table for field subcat on 'Ressource'
        db.create_table(u'ressource_subcat', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ressource', models.ForeignKey(orm['opst_plugins.ressource'], null=False)),
            ('souscategorie', models.ForeignKey(orm['opst_plugins.souscategorie'], null=False))
        ))
        db.create_unique(u'ressource_subcat', ['ressource_id', 'souscategorie_id'])


    def backwards(self, orm):
        # Removing M2M table for field category on 'Ressource'
        db.delete_table('ressource_category')

        # Removing M2M table for field subcat on 'Ressource'
        db.delete_table('ressource_subcat')
    ...
    models = {
        ...
        'opst_plugins.ressource': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['opst_plugins.Categorie']", 'null': 'True', 'blank': 'True'}),
            ...
            'subcat': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['opst_plugins.SousCategorie']", 'null': 'True', 'blank': 'True'}),
